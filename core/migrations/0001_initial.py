    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='name', max_length=4000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='name', max_length=4000)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_column='created_at')),
                ('category_id', models.ForeignKey(db_column='category_id', on_delete=django.db.models.deletion.CASCADE, to='core.ledger_category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amt', models.DecimalField(db_column='amt', decimal_places=2, max_digits=8)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_column='created_at')),
                ('shop_id', models.ForeignKey(db_column='shop_id', on_delete=django.db.models.deletion.CASCADE, to='core.ledger_shop')),
            ],
            options={
